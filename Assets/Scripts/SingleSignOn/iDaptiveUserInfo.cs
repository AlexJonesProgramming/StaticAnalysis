...
{
    /// <summary>
    /// Description of the user information data for the iDaptive client
    /// </summary>
    public class iDaptiveUserInfo : IUserInfo
    {
        ...
        public iDaptiveUserInfo(string loginName, string email)
        {
